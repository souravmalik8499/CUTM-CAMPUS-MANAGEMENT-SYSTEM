                ...
                if (resp.length > 0) {
                    ...
                    fs.writeFile(newPath, photoData, function (err) {
                        ...
                        newSchool.save().then(savedData => {
                            ...
                            res.status(200).json({ success: true, data: savedData, message:"CAMPUS is Registered Successfully." })
                        }).catch(e => {
    ...
    getSchoolOwnData: async(req, res)=>{
        ...
        School.findById(id).then(resp=>{
            if(resp){
                ...
                res.status(500).json({ success: false, message: "CAMPUS data not Available" })
            }
        }).catch(e=>{
